...
<body>
    <div class="container-fluid" id="content">
        ...
        <hr>
        <p>Para cambiar tu contraseña, debes recordar la que tienes actualmente. En caso de que la hayas olvidado, puedes intentar <a id="fPassLink" class="btn btn-primary" href="forgottenPass.php" role="button">recuperarla.</a> o <a id="fPassLink" class="btn btn-primary" href="index.php" role="button">volver al inicio.</a>
        </p>
