	...
	class Users extends DB{
		...
		public function signUp(){
			...
			if($query = true){
				...
				echo'<script type="text/javascript"> alert("¡OH NO! Lamentamos la molestia, pero ah ocurrido un error al momento del registro. Por favor, intentalo de nuevo."); </script>';
			}
		}
		public function updateAccount(){
            ...
            if($query1 = true){
                ...
                echo'<script type="text/javascript"> alert("¡OH NO! Ocurrio un error al momento de modificar tu duenta. Intentalo de nuevo"); </script>';
            }
		}
	}
