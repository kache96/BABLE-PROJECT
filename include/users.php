...
@ini_set('display_errors', 0);
	class Users extends DB{
		...
		public function changePass(){
			...
			{
				echo'<script type="text/javascript"> alert("¡Ups! Te falto 1 o varios campos por llenar. Intentalo de nuevo."); window.location.href="changePassword.php";</script>';
				exit();
			}
			$userSession = new UserSession();
            $user = new User();
			...
			if(strlen($this->pass) < 8)
			{
				echo'<script type="text/javascript"> alert("¡Ups!La contraseña debe contener minimo 8 caracteres. Ingresa una contraseña mas compleja.");  window.location.href="changePassword.php"; </script>';
				exit();
			}
			
			if(strlen($this->pass) > 32)
			{
				echo'<script type="text/javascript"> alert("¡Ups! La contraseña debe contener maximo 32 caracteres. Ingresa una contraseña mas compleja.");  window.location.href="changePassword.php"; </script>';
				exit();
			}
			
			if(!preg_match("/\d/", $this->pass))
			{
				echo'<script type="text/javascript"> alert("¡Ups! La contraseña debe tener al menos 1 caracter numerico. Ingresa una contraseña mas compleja.");  window.location.href="changePassword.php"; </script>';
				exit();
			}
			
			if(!preg_match("/[A-Z]/", $this->pass))
			{
				echo'<script type="text/javascript"> alert("¡Ups! La contraseña debe tener al menos 1 letra en mayuscula. Ingresa una contraseña mas compleja.");  window.location.href="changePassword.php"; </script>';
				exit();
			}
			if($this->pass != $this->vpass)
			{
				echo'<script type="text/javascript"> alert("¡Ups! ¿Algun caracter omitido? Recuerda que las contraseñas deben ser iguales. Intentalo de nuevo.");  window.location.href="changePassword.php";</script>';
				exit();
			}
            $userSession = new UserSession();
            $user = new User();
