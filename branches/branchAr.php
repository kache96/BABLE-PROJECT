...
<body>
        ...
        <ul class="navbar-nav pull-sm-right">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                      <a class="dropdown-item" href="#user"><i class="material-icons" id="configIcon">settings</i>Configuracion</a>
    ...
    <div class="container-fluid" id="content">
        <div class="row">
                ...
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <div class="collapse" id="langE">
                        <ul id="itemDrop">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" onclick='enB2()' id="itemDropDrop">Nivel A2</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="collapse" id="langF">
                        <ul id="itemDrop">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" onclick='frB2()' id="itemDropDrop">Nivel A2</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="collapse" id="langI">
                        <ul id="itemDrop">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" onclick='itB2()' id="itemDropDrop">Nivel A2</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="collapse" id="langA">
                        <ul id="itemDrop">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" onclick='alB2()' id="itemDropDrop">Nivel A2</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="collapse" id="langP">
                        <ul id="itemDrop">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" onclick='poB2()' id="itemDropDrop">Nivel A2</a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="col-9" id="containerLevelsC">
                <div id="langLevel">
                    <h1 id="level"></h1>
                    <hr>
                    <p>A continuación veras el calendario con los días en los que podrás reservar tu cupo.
                        <br><br>
                        El horario de reserva inicia a las 6:00am y finaliza a las 7:30pm en semana. Los sábados inicia a las 6:30am y finaliza a las 3:00pm.
                        <br>
