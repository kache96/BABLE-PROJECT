...
<head>
    ...
    <title>Bable | Administrativa</title>
</head>
    ...
    <div class="container-fluid" id="content">
        ...
        <div class="row">
            ...
            <div class="col-9" id="containerInfo">
                <h1>Bienvenido a la sede <b id="branchName">Administrativa</b></h1>
                <hr>
            ...
            <div class="col-9" id="containerLevelsC" hidden>
                <div id="langLevel">
                    ...
                    <p>A continuación veras el calendario con los días en los que podrás reservar tu cupo.
                        ...
                        <br>
                        Nota: Le recordamos que no podrá reservar su cupo para el día domingo.
                    </p>
                    <table class="table">
                        <thead>
                        <tr>
                            HORARIO
                            <br>
                            La hora que elija para reservar su cupo, debera estar escrita en formato 24.
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
                        ...
                        <tr>
                            <td>06:00, 06:30, 07:30, 08:00, 09:00, 10:30</td>
                            <td>12:00, 13:30, 15:00, 16:30, 18:00, 19:30</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
