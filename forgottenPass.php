...
<body>
    <div class="container-fluid">
            ...
            <form action="" method="post">
                <div id="welcome">
                    ...
                    <p>Antes de proceder a la recuperacion de su cuenta, le informamos que es total y
                        ...
                        <br><br>
                        En caso de que las hayas olvidado, puedes hablar con el administrador.
                    </p>
                </div>
                <div id="userID">
                <div class="row" >
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <input type="text" placeholder="Contraseña nueva" name="pass" class="form-control" >
                                </div>
                                <div class="col-sm-6">
                                    <input type="text" placeholder="Confirmar contraseña" name="vpass" class="form-control" >
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container-fluid" id="head">
            <img src="img/Backgrounds/banners/bannerBottom.png" />
        </div>
    </div>
<script>
    function hideUser() {
