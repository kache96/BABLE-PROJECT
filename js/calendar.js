$(document).ready(function() {
  $("#bubleCalendar").fullCalendar({
    ...
    dayClick: function(date, jsEvent, view) {
      ...
      $("#event_id").css("Opacity: -0", true);
      $("#langLvl").css("Opacity: -0", true);
      $("#branch").css("Opacity: -0", true);
    ...
    eventClick: function(calEvent, jsEvent, view) {
      ...
      $("#event_id").css("Opacity: -0", false);
      $("#langLvl").css("Opacity: -0", false);
      $("#branch").css("Opacity: -0", false);
