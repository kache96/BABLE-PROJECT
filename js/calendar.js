$(document).ready(function() {
  $("#bubleCalendar").fullCalendar({
    ...
    dayClick: function(date, jsEvent, view) {
      ...
      $("#studentName").css("height: 0px", true);
      $("#langLvl").css("height: 0px", true);
      $("#branch").css("height: 0px", true);
    ...
    eventClick: function(calEvent, jsEvent, view) {
      ...
      $("#studentName").css("height: 0px", false);
      $("#langLvl").css("height: 0px", false);
      $("#branch").css("height: 0px", false);
